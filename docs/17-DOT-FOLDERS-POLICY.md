...
- `docs/18-REPOSITORY-CHANGE-POLICY.md` — سياسة تغيير المستودع العامة (F-10)؛
  تُعمِّم مبدأ F-9 على أي ملف/مجلد جديد خارج النطاق، ولا تقرر حذف/نقل أي artifact موجود.
