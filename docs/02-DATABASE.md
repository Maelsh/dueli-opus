...
## سياسة عدم استرداد التبرعات (8.G-F3)

> المصدر canonical للسياسة: هذا القسم + `src/models/DonationModel.ts::DONATIONS_NON_REFUNDABLE`.
> قرار رسمي من Project Lead (لم تكن توجد سياسة سابقة — سُجّل الفراغ في 8.G ثم حُسم هنا).

- **جميع التبرعات في Dueli غير قابلة للاسترداد مطلقاً بعد إتمامها** — حتى لو لم يسحب المتلقي أي جزء منها.
- **لا يوجد refund عادي للتبرعات**: لا كامل ولا جزئي، لا clawback، لا رصيد سالب، لا دين على المتلقي بسبب refund، ولا تحميل المنصة أي عجز.
