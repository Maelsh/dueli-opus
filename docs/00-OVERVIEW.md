...
> الجرد الكامل والسياسة الملزمة في `docs/17-DOT-FOLDERS-POLICY.md`).
>
> سياسة تغيير المستودع العامة — أي ملف/مجلد جديد خارج نطاق المهمة ممنوع
> دون إذن صريح (`docs/18-REPOSITORY-CHANGE-POLICY.md`، تعميم لسياسة F-9).
