...
export const en = {
    ...
    notification: {
        ...
        new_post_comment_body: '{actor} commented on your post',
        new_comment: 'New Comment',
        new_comment_body: '{actor} commented on the competition',
    ...
    reconnect_failed: 'Could not restore the connection',
    connect: 'Connect',
    join: 'Join',
    ...
    ads: {
        ...
        // ── Phase 9.C: metrics and anti-fraud ─────────────────
        impressions: 'Impressions',
        clicks: 'Clicks',
        ctr: 'CTR',
        spend: 'Spend',
